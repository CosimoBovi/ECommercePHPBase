...
if ($Dati["action"] == "getProductByID"){
    $product=getProductById($Dati["productID"]);
    echo json_encode(['product' => $product]);
}

if ($Dati["action"] == "getPriceStats"){
    $SumAndAvg=calculateTotalAndAveragePrices() ;
    echo json_encode($SumAndAvg);
}
